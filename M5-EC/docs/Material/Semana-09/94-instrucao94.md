---
sidebar_label: "10 - Encontro de Computação"
---
...
- Neste encontro, os alunos irão trabalhar no processo de integração dos elementos de sua solução. 
- Eles receberão auxilio no processo de testes e implementação da comunicação.
