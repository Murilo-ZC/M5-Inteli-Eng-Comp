---
sidebar_label: "9 - Encontro de Computação"
---
...
- Os protocolos de comunicação entre dispositivos são apresentados durante este encontro. 
- Ao final, os alunos deverão ser capazes de selecionar quais protocolos devem ser utilizados diante da situação de integração que será realizada.
